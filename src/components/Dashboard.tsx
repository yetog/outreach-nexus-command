...
import { Users, Mail, Calendar, BarChart3 } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Outreach Automation Platform</h1>
          <p className="text-gray-600 mt-2">Manage your outreach campaigns, contacts, and analytics</p>
        </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="grid w-full grid-cols-4">
            ...
            <TabsTrigger value="scheduler">Campaign Scheduler</TabsTrigger>
